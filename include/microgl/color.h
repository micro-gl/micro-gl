...
namespace microgl {
    ...
    struct rgba_t {
        static constexpr microgl::uint8_t r = R;
        static constexpr microgl::uint8_t g = G;
        static constexpr microgl::uint8_t b = B;
        static constexpr microgl::uint8_t a = A;
     ...
     */
    template<class rgba, microgl::uint8_t alpha_fallback=8>
    ...
    template<microgl::uint8_t bits_from, microgl::uint8_t bits_to>
    inline microgl::uint_t<bits_to> convert_channel_correct(const microgl::uint_t<bits_from> &input) {
        ...
        constexpr microgl::uint8_t overall_bits = bits_from+bits_to+bits_used;
//            constexpr bool overflow = false;
//            constexpr bool overflow = true;
        constexpr bool overflow = overall_bits>=32;
        microgl::uint32_t result = 0;

        if(overflow) result = ((microgl::uint32_t)input*max_output)/max_input;
        else result = ((microgl::uint32_t)input*max_output*multiplier + half)>>p;
        return result;
    }
...
//            constexpr bool overflow = true;
        ...
        if(overflow) result = ((microgl::uint32_t)a*b)/max_value;
    ...
    template<microgl::uint8_t bits_a, microgl::uint8_t bits_b, microgl::uint_t<bits_b> b>
    inline microgl::uint_t<bits_a-bits_b+1> div(
            const microgl::uint_t<bits_a> & a) {
        using uint_b = microgl::uint_t<bits_b>;
        constexpr microgl::uint8_t p = bits_b + 12;
        constexpr microgl::uint8_t bits_used_multiplier = p + 1 - bits_b;
        using uint_multiplier = microgl::uint_t<bits_used_multiplier>;
        using uint_p = microgl::uint_t<p>;
        using uint_result = microgl::uint_t<bits_a-bits_b+1>;
...
//            constexpr bool overflow = false;
        ...
        if(overflow) result = ((microgl::uint32_t)a)/b;
