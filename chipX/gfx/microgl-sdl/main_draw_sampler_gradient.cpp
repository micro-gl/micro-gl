...
#include <microgl/samplers/linear_gradient.h>
...
void test_1() {
//    t+=0.001;
    canvas->drawQuad<blendmode::Normal, porterduff::None, linear_gradient<10>, number>(gradient, t, t, 400, 400);
