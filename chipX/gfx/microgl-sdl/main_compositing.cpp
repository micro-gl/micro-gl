...
//
    ...
    bmp_1 = bmp_1_native->convertToBitmap<coder::RGB888_PACKED_32>();
    bmp_2 = bmp_2_native->convertToBitmap<coder::RGB888_PACKED_32>();
    mask = bmp_3_native->convertToBitmap<coder::RGB888_PACKED_32>();
    resources.init();
}
