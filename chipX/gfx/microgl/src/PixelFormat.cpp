...
uint16_t encode_RGB565(color_t rgb) {
...
color_t decodeRGB(int color, PixelFormat format) {
    ...
    switch (format) {
        ...
        case RGB888:
            res.r = (color & 0xFF000000) >> 16;
            res.g = (color & 0x00FF0000) >> 8;
            res.b = (color & 0x0000FF00);
            break;
        case RGB565:
...
color_f_t decodeFloatRGB(int color, PixelFormat format) {
    ...
    switch (format) {
        ...
        case RGB888:
            ...
            break;
        case RGB565:
            r_max_value = 31; g_max_value = 63; b_max_value = 31; a_max_value = 1;
            break;
        case RGB555:
            r_max_value = 31; g_max_value = 31; b_max_value = 31; a_max_value = 1;
            break;
        case RGB332:
            r_max_value = 7; g_max_value = 7; b_max_value = 3; a_max_value = 1;
            break;
        case RGB8:
            r_max_value = 255; g_max_value = 255; b_max_value = 255; a_max_value = 255;
            break;
