...
color_f_t blend_Overlay(const color_f_t &b, const color_f_t &s) {
...
// normal s
color_f_t blend_Normal(const color_f_t &b, const color_f_t &s) {
    return s;
}


// multiply s
color_f_t blend_Multiply(const color_f_t &b, const color_f_t &s) {
...
color_f_t blend_Divide(const color_f_t &b, const color_f_t &s) {
...
// screen s
float blend_Screen(float b, float s) {
    return 1.0-((1.0-b)*(1.0-s));
}

color_f_t blend_Screen(const color_f_t &b, const color_f_t &s) {
...
// darken s
float blend_Darken(float b, float s) {
    return fmin(s,b);
}

color_f_t blend_Darken(const color_f_t &b, const color_f_t &s) {
...
// lighten s
float blend_Lighten(float b, float s) {
    return fmax(s,b);
}

color_f_t blend_Lighten(const color_f_t &b, const color_f_t &s) {
...
// color-dodge s
float blend_ColorDodge(float b, float s) {
    return (s==1.0)?s:fmin(b/(1.0-s),1.0);
}

color_f_t blend_ColorDodge(const color_f_t &b, const color_f_t &s) {
...
// color-burn s
float blend_ColorBurn(float b, float s) {
    return (s==0.0)?s:fmax((1.0-((1.0-b)/s)),0.0);
}

color_f_t blend_ColorBurn(const color_f_t &b, const color_f_t &s) {
...
// hard-light s
color_f_t blend_HardLight(const color_f_t &b, const color_f_t &s) {
    return blend_Overlay(s,b);
}

// soft-light s
float blend_SoftLight(float b, float s) {
    return (s<0.5) ? (2.0*b*s+b*b*(1.0-2.0*s)) : (sqrt(b)*(2.0*s-1.0)+2.0*b*(1.0-s));
}

color_f_t blend_SoftLight(const color_f_t &b, const color_f_t &s) {
...
// difference s
color_f_t blend_Difference(const color_f_t &b, const color_f_t &s) {
...
// exclusion s
color_f_t blend_Exclusion(const color_f_t &b, const color_f_t &s) {
    color_f_t res;
...
float blend_LinearBurn(float b, float s) {
    return fmax(b + s - 1.0, 0.0f);
}

color_f_t blend_LinearBurn(const color_f_t &b, const color_f_t &s) {
    color_f_t res;
...
// linear-dodge s
float blend_LinearDodge(float b, float s) {
    // Note : Same implementation as sAddf
    return fmin(b+s,1.0);
}

color_f_t blend_LinearDodge(const color_f_t &b, const color_f_t &s) {
...
// linear-light s
float blend_LinearLight(float b, float s) {
    return (s < 0.5) ? blend_LinearBurn(b,(2.0*s)) : blend_LinearBurn(b,(2.0*(s-0.5)));
}

color_f_t blend_LinearLight(const color_f_t &b, const color_f_t &s) {
...
// negation s
color_f_t blend_Negation(const color_f_t &b, const color_f_t &s) {
    color_f_t res;
...
// pin-light s
float blend_PinLight(float b, float s) {
    return (s < 0.5) ? blend_Darken(b,(2.0*s)) : blend_Lighten(b,(2.0*(s-0.5)));
}

color_f_t blend_PinLight(const color_f_t &b, const color_f_t &s) {
...
// reflect s
float blend_Reflect(float b, float s) {
    return (s==1.0)?s:fmin(b*b/(1.0-s),1.0);
}

color_f_t blend_Reflect(const color_f_t &b, const color_f_t &s) {
...
// substract s
float blend_Substract(float b, float s) {
    return fmax(b+s-1.0,0.0);
}

color_f_t blend_Substract(const color_f_t &b, const color_f_t &s) {
...
// substract s
float blend_Subtract(float b, float s) {
    return fmax(b-s, 0.0);
}

color_f_t blend_Subtract(const color_f_t &b, const color_f_t &s) {
...
// vivid-light s
float blend_VividLight(float b, float s) {
    return (s < 0.5) ? blend_ColorBurn(b, (2.0*s)) : blend_ColorDodge(b,(2.0*(s-0.5)));
}

color_f_t blend_VividLight(const color_f_t &b, const color_f_t &s) {
...
// hard-mix s
float blend_HardMix(float b, float s) {
    return (blend_VividLight(b,s)<0.5)?0.0:1.0;
}

color_f_t blend_HardMix(const color_f_t &b, const color_f_t &s) {
