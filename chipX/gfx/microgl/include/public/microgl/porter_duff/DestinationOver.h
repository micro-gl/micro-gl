...
namespace porterduff {
    ...
    public:
        ...
        inline static void composite(const color_t & b,
            ...
            internal_porter_duff(max_val-b.a, max_val, b, s, output, alpha_bits, multiplied_alpha_result);
        }
        ...
        inline static void composite(const color_f_t & b,
                                     ...
                                     color_f_t &output,
                                     bool multiplied_alpha_result=false) {
            internal_porter_duff(1.0 - float(b.a), 1.0, b, s, output, multiplied_alpha_result);
        }
