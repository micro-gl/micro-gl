...
namespace microgl {
    namespace sampling {
        ...
        class line_linear_gradient : public sampler<line_linear_gradient<N>> {
            using base= sampler<line_linear_gradient<N>>;
        ...
        public:
            ...
            void setLine(const vec2<number> & start, const vec2<number> & end) {
