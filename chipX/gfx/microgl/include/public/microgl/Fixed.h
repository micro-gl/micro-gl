...
#define float_to_fixed_2(a, q) ((long long)(0.0f + (a)*(float)(1<<(q)) ))
...
#define fixed_mul_fixed_2(a,b,q) (((((long long)(a))*(b)))>>(q))
#define fixed_div_fixed_2(a,b,q) ((((long long)(a))<<(q))/(b))
#define fixed_mul_fixed(a,b) (fixed_mul_fixed_2(a,b,Q_))
#define fixed_div_fixed(a,b) (fixed_div_fixed_2(a,b,Q_))
...
#define fixed_mul_int(a,b) ((long long)(a)*(b))
#define fixed_div_int(a,b) ((a)/(b))
#define fixed_one_over_int(a) fixed_div_int(fixed_one, a)
#define fixed_add_int(a,b) (fixed_add_int2(a,b,Q_))
...
#define MASK_FRACTION_BITS ((1<<Q_) - 1)
...
#define fixed_one_over_fixed(a) ((((long long)fixed_one)<<Q_)/(a))
#define fixed_one_over_fixed_2(a, q) ((((long long)1)<<((q)<<1))/(a))
