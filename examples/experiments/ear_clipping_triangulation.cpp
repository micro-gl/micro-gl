namespace microgl {
    namespace tessellation {
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        auto
        ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::polygon_to_linked_list(const vertex *$pts,
                                                                   index offset,
                                                                   index size,
                                                                   bool reverse,
...
//            return last;
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        void ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::compute(const vertex *polygon,
                                                         index size,
...
//            compute(outer, size, indices_buffer_triangulation, boundary_buffer, output_type);
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        void ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::update_ear_status(node_t *vertex, const int &polygon_orientation) {
//            if(!vertex->isValid()) {
//                vertex->is_ear=false;
//                return;
//            }
...
//            vertex->is_ear=is_convex && is_empty;
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        void ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::compute(node_t *list,
                                                         index size,
                                                         container_output_indices & indices_buffer_triangulation,
                                                         container_output_boundary * boundary_buffer,
                                                         microgl::triangles::indices &output_type) {
...
//            }
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        auto ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::remove_degenerate_from(node_t *v, bool backwards) ->node_t * {
...
//            return anchor;
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        number
        ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::orientation_value(const vertex *a,
                                                              const vertex *b,
                                                              const vertex *c) {
...
//            return (b->x-a->x)*(c->y-a->y) - (c->x-a->x)*(b->y-a->y);
        ...
        // ts
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        int ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::neighborhood_orientation_sign(
                const node_t *v) {
//            return sign_orientation_value(v->prev->pt, v->pt, v->next->pt);
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        char
        ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::sign_orientation_value(const vertex *i,
                                                                   const vertex *j,
                                                                   const vertex *k) {
...
//            else return 0;
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        auto ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::maximal_y_element(node_t *list) -> node_t * {
//            node_t * first = list;
...
//            return maximal_index;
        ...
        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        bool ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::isDegenerate(const node_t *v) {
            return sign_orientation_value(v->prev->pt, v->pt, v->next->pt)==0;
        }

        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        bool ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::areEqual(const node_t *a,
                                                          const node_t *b) {
//            return a==b;
        }

        template <typename number, class container_output_indices, class container_output_boundary, class computation_allocator>
        bool ear_clipping_triangulation<number, container_output_indices, container_output_boundary, computation_allocator>::isEmpty(node_t *v) {
//            int tsv;
